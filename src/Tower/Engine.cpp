...
void Engine::sendMessage(const Message& message)
{
    ...
    else if (message.type == Message::Type::EngineChangeResolution)
    {
        loadConfig();
        ...
        if (!Config::Display::Fullscreen)
        {
            ...
            SDL_SetWindowSize(m_window, Config::Display::Width, Config::Display::Height);
        ...
        else
        {
            ...
            mode.w = Config::Display::Width;
            mode.h = Config::Display::Height;
